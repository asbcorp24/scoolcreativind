...
<div class="col-lg-5"><label class="form-label">Или загрузить файл</label><input type="file" class="form-control" name="file" accept=".jpg,.jpeg,.png,.webp,.glb,.gltf"><div class="form-text text-white-50">До 50 МБ.</div></div>
