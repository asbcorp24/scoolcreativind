...
@section('content')
<section class="page-top"><div class="container"><div class="eyebrow">Control center</div><div class="d-flex justify-content-between align-items-end flex-wrap gap-3"><h1 class="display-2 fw-bold m-0">Админ-панель</h1><div class="d-flex gap-2 flex-wrap"><a href="{{ route('admin.studios.create') }}" class="btn btn-neon">+ Раздел</a><a href="{{ route('admin.news.create') }}" class="btn btn-ghost">+ Новость</a><a href="{{ route('admin.projects') }}" class="btn btn-ghost">Проекты</a><a href="{{ route('admin.events') }}" class="btn btn-ghost">События</a><a href="{{ route('admin.team') }}" class="btn btn-ghost">Команда</a><a href="{{ route('admin.equipment') }}" class="btn btn-ghost">Оборудование</a><a href="{{ route('admin.schedule') }}" class="btn btn-ghost">Расписание</a><a href="{{ route('admin.groups') }}" class="btn btn-ghost">Учебные группы</a><a href="{{ route('admin.subjects') }}" class="btn btn-ghost">Предметы</a><a href="{{ route('admin.journal') }}" class="btn btn-ghost">Журнал</a><a href="{{ route('admin.homework') }}" class="btn btn-ghost">Домашние задания</a><a href="{{ route('admin.students') }}" class="btn btn-ghost">Ученики</a><a href="{{ route('admin.competitions') }}" class="btn btn-ghost">Конкурсы</a><a href="{{ route('admin.settings') }}" class="btn btn-ghost">Настройки сайта / SEO</a></div></div></div></section>
